...
Tested on **Proxmox VE 7 and 8 and 9**.

Original creator: https://github.com/my5t3ry/machine-to-proxmox-lxc-ct-converter
I updated it to work for the newer version of Proxmox with Claude AI.
